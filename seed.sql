...
INSERT IGNORE INTO organization (id, org_name, org_address, org_number, alcohol_enabled, food_enabled, created_at) VALUES
...
INSERT IGNORE INTO org_user_bridge (org_id, user_id, user_role, created_at) VALUES
...
INSERT IGNORE INTO todo (id, task, assigned_to, org_id) VALUES
(1, 'Review supplier approval list before next audit.', 2, 1),
(2, 'Update bar incident escalation contacts.', 8, 2),
(3, 'Replace damaged cooling labels in pastry prep area.', 10, 3),
(4, 'Confirm allergy matrix posted on prep wall.', 5, 1),
(5, 'Verify age-check poster placement at both tills.', 6, 2);

INSERT IGNORE INTO interval_rule (id, interval_start, interval_repeat_time, created_at) VALUES
...
INSERT IGNORE INTO course (id, title, course_description, org_id, created_at) VALUES
...
INSERT IGNORE INTO course_link (id, course_id, link, created_at) VALUES
...
INSERT IGNORE INTO user_course_bridge_responsible (course_id, user_id, created_at) VALUES
...
INSERT IGNORE INTO course_user_bridge_progress (course_id, user_id, is_completed, last_updated, created_at) VALUES
...
INSERT IGNORE INTO prerequisite_category (id, category_name, org_id, created_at) VALUES
...
INSERT IGNORE INTO prerequisite_standard (id, standard_name, standard_description, prerequisite_category_id, created_at) VALUES
...
INSERT IGNORE INTO prerequisite_routine (id, immediate_corrective_action, title, prerequisite_category_id, prerequisite_description, org_id, interval_id, created_at) VALUES
...
INSERT IGNORE INTO routine_user_bridge (user_id, routine_id, user_role, created_at) VALUES
...
INSERT IGNORE INTO mapping_point (id, title, challenges, measures, responsible_for_point, law, severity_dots, org_id, created_at) VALUES
...
INSERT IGNORE INTO ccp (id, how, equipment, instructions_and_calibration, immediate_corrective_action, critical_min, critical_max, unit, ccp_name, monitored_description, org_id, interval_id, created_at) VALUES
...
INSERT IGNORE INTO ccp_user_bridge (user_id, ccp_id, user_role, created_at) VALUES
...
INSERT IGNORE INTO ccp_corrective_measure (id, product_category_id, ccp_id, measure_description, created_at) VALUES
...
INSERT IGNORE INTO ccp_record (id, org_id, ccp_id, last_verifier, verification_status, verified_at, performed_by, comment, measured_value, critical_min, critical_max, unit, ccp_name, created_at) VALUES
...
INSERT IGNORE INTO prerequisite_routine_record (id, org_id, routine_id, performed_by, result_status, comment, last_verifier, verification_status, verified_at, created_at) VALUES
...
INSERT IGNORE INTO deviation (id, ccp_record_id, routine_record_id, org_id, reported_by, category, reviewed_by, review_status, reviewed_at, what_went_wrong, immediate_action_taken, potential_cause, potential_preventative_measure, preventative_measure_actually_taken, created_at) VALUES
...
INSERT IGNORE INTO internal_control_review (id, org_id, reviewed_by, summary, created_at) VALUES
