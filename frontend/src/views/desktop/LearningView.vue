...
const allCourses = [
    {
        name: 'Serveringskurs',
        description: "Dere må lese here pdf’en & skrive en oppsummering. Dere må også gjøre alle oppgaver i NDLA sitt kurs og levere det inn til oss.",
        resources: [
            {
        ...
        <div class="course" v-for="course in allCourses" :key="course.uniqueId">
            ...
            <div>
                ...
                <div class="resource-container">
                    <Badge badge-color="navy" :icon="resource.type === 'link' ? Link : File" v-for="resource in course.resources">
                        {{ resource.name }}
                    </Badge>
                </div>
            </div>
