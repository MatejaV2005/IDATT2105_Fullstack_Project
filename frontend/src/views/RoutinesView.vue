  ...
  <section class="page-layout">
    ...
    <div class="routine-grid">
      <article v-for="routine in routines" :key="routine.id" class="routine-card routine-card--checkable">
        ...
        <article v-if="openInfoId === routine.id" class="info-popover routine-card__info">
          <p class="info-popover__title">Beskrivelse</p>
          <p class="card-copy">{{ routine.description }}</p>
        </article>
